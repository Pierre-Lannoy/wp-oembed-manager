				...
				if ( ! in_array( 'perfopsone-' . $menu, self::$slugs, true ) ) {
					switch ( $menu ) {
						...
						case 'settings':
							...
							break;
						case 'consoles':
							add_menu_page( esc_html__( 'Available Consoles', 'oembed-manager' ), sprintf( esc_html__( '%s Consoles', 'oembed-manager' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_consoles_page' ], 'dashicons-embed-generic', 6666 );
							add_submenu_page( 'perfopsone-' . $menu, esc_html__( 'Available Consoles', 'oembed-manager' ), __( 'Available Consoles', 'oembed-manager' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_sconsoles_page' ], 0 );
							break;
					}
